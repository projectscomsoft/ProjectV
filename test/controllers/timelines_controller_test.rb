...
class TimelinesControllerTest < ActionController::TestCase
  ...
  test "should create timeline" do
    assert_difference('Timeline.count') do
      post :create, timeline: { focus_date: @timeline.focus_date, initial_zoom: @timeline.initial_zoom, title: @timeline.title }
    end
  ...
  test "should update timeline" do
    patch :update, id: @timeline, timeline: { focus_date: @timeline.focus_date, initial_zoom: @timeline.initial_zoom, title: @timeline.title }
    assert_redirected_to timeline_path(assigns(:timeline))
  end
